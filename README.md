...
<img width="456" height="412" alt="image" src="https://github.com/user-attachments/assets/380be52a-532b-46d9-801b-1ac5f0896fd6" />

### Страница авторизации
- Форма создания нового аккаунта
- Валидация полей ввода
<img width="413" height="443" alt="image" src="https://github.com/user-attachments/assets/10faf7bf-c32d-4ce9-93b0-bc1b9cd5134d" />

### Главная страница
- Панель навигации с быстрым доступом к основным разделам
- Круглое меню для перехода между модулями
<img width="656" height="312" alt="image" src="https://github.com/user-attachments/assets/28845471-4c63-4039-b368-6e6920eb8b2c" />

### Страница транзакций
- Таблица с историей операций
- Форма добавления новых транзакций
- Интерактивная диаграмма доходов/расходов
<img width="665" height="355" alt="image" src="https://github.com/user-attachments/assets/863b9843-3f51-4fce-bef2-11c217bb2bea" />

### Управление затратами
- Круговая диаграмма распределения расходов
- Форма добавления финансовых целей
- Возможность удаления записей
<img width="650" height="373" alt="image" src="https://github.com/user-attachments/assets/663576d1-6fe5-4c8a-8ca0-7c12c188bc5f" />

### Управление накоплениями
- Список существующих целей накоплений
- Форма создания новых накоплений с выбором категории
- Функция добавления средств к существующим целям
- Визуализация прогресса накоплений
<img width="657" height="402" alt="image" src="https://github.com/user-attachments/assets/cb2d7ed0-bfd9-40a4-ba5e-3e2cb8e2e2a0" />
